...
%%%%%%%%%%%%%%%%%%% 2024/2/21 %%%%%%%%%%%%%%%%%%%
% ZD added this script because the F matrix in the interneuron pipeline output is
% reversed
%%%%%%%%%%%%%%%%%%% 2024/2/21 %%%%%%%%%%%%%%%%%%%
...
for n = 1:numfiles
    ...
    fullFfile=[Ffilepath{n} Ffile{n}]
     pause(1);
      save(fullFfile,'ybinned','rewards','forwardvel','licks','changeRewLoc',...
          'trialnum','timedFF','lickVoltage', 'scanstop', 'scanstart', ...
          'VR', '-append');
      if addabf

...
%    tool=imtool3D(chone(:,:,:));
%    tool1=imtool3D(chone(:,80:720,:)); figure,plot(testmean);
 tool1=imtool3D(chone(:,80:720,1:4:end)); figure,plot(testmean(1:4:end));
 tool2=imtool3D(chone(:,80:720,2:4:end));figure,plot(testmean(2:4:end));
 tool3=imtool3D(chone(:,80:720,3:4:end));figure,plot(testmean(3:4:end));
 tool4=imtool3D(chone(:,80:720,4:4:end));figure,plot(testmean(4:4:end));

%  tool1=imtool3D(chone(:,:,1:3:end)); figure,plot(testmean(1:3:end));
%  tool2=imtool3D(chone(:,:,2:3:end));figure,plot(testmean(2:3:end));
%  tool3=imtool3D(chone(:,:,3:3:end));figure,plot(testmean(3:3:end));

%  tool1=imtool3D(chone(:,80:720,1:3:end)); figure,plot(testmean(1:3:end));
%  tool2=imtool3D(chone(:,80:720,2:3:end));figure,plot(testmean(2:3:end));
%  tool3=imtool3D(chone(:,80:720,3:3:end));figure,plot(testmean(3:3:end));

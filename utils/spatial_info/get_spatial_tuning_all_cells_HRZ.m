...
function cell_activity = get_spatial_tuning_all_cells_HRZ(Fc3,position,velocity,Fs,nBins,track_length)
...
nCells = size(Fc3,2);
for cell = 1:nCells
    cell_activity(cell,:) = get_spatial_tuning_per_cell_HRZ(Fc3(:,cell),position,velocity,Fs,nBins,track_length);
end

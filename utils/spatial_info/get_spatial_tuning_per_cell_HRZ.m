...
function cell_activity_smoothed = get_spatial_tuning_per_cell_HRZ(Fc3,position,velocity,Fs,nBins,track_length)
%% Fc3 = dFF of 1 cell 
...
time_moving = get_moving_time_V2(velocity,2,Fs);
...
for bin = 1:nBins
   cell_activity(bin) = nanmean(Fc3(time_in_bin{bin})); 
end

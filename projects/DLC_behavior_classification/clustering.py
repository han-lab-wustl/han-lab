...
date='230215'
day=2
df = pd.read_csv(rf'Y:\DLC\DLC_networks\pupil_licks_nose_paw-Zahra-2023-02-27\videos\{date}_E201DLC_resnet50_pupil_licks_nose_pawFeb27shuffle1_50000.csv')
mat = loadmat(rf'Z:\sstcre_imaging\e201\{day}\{date}_ZD_000_001\suite2p\plane0\Fall.mat') # load fall with behavior aligned data

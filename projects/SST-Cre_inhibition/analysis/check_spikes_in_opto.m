...
[dffs,diff_opto,spatial_info,spike_optos,spike_opto_comps,...
...
[dffs,diff_opto,spatial_info,spike_optos_ctrl,spike_opto_comps_ctrl,...
...
figure; plot(1, diff_spike_opto, 'ro'); hold on; plot(2, diff_spike_opto_ctrl, 'ko');
plot(1, mean(diff_spike_opto), 'r_', 'MarkerSize',30, 'LineWidth',3)
plot(2, mean(diff_spike_opto_ctrl,'omitnan'), 'k_', 'MarkerSize',30, 'LineWidth',3)
xlim([0 3])
xticks([1 2])

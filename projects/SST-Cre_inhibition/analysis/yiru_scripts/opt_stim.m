...
Settings.hrz_days = [55:61]; % get these days; ZD added for her folder structure
...
% MESSY
Settings.hrz_days = [55:61]; % get days after this day; ZD added for her folder structure
...
rewrange = 10 *2/3;
optodays = [1 2 4 5 7]; % only run get opto frames on these days?

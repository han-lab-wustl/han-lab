function p = sr_comparisonplots(opto_data, ctrl_data, pre_color, post_color, labels)
nexttile
...
nexttile
comparestatsplots(opto_data(opto_data(:,4)==1,3),ctrl_data(:,3), pre_color, post_color, [1 2]); hold on
xlim([0 3])
xticks([1 2])
ylabel('Success Rate')
ylim([0 1])
...
nexttile
comparestatsplots(opto_data(opto_data(:,4)==2,3),ctrl_data(:,3), pre_color, post_color, [1 2]); hold on
xlim([0 3])
xticks([1 2])
ylabel('Success Rate')
ylim([0 1])
...
nexttile
comparestatsplots(opto_data(opto_data(:,4)==3,3),ctrl_data(:,3), pre_color, post_color, [1 2]); hold on
xlim([0 3])
xticks([1 2])
ylim([0 1])
ylabel('Success Rate')

function make_proc_files_from_F_file_Ints(plane,day_num)

[file,path] = uigetfile('*_F.mat',['Select the F file with interneuron' ...
    'cellular data from plane ',num2str(plane), ' on day ',num2str(day_num) ]);
day_1 = load([path file]);
load('C:\Users\Han Lab\SH_F_files\F_M94_Day 3_plane3_proc.mat')
%%

% iscell value in dat struct
...
filename = [path file(1:end-17) '_int_proc_file.mat'];
save(filename,'dat');

...
for animal in animals_test:
    ...
    vmin = 0
    vmax = np.nanquantile(tc, 0.98)  # 95th percentile
    ...
    fig.suptitle('Far post-reward cells')
...
ax.set_title('Far post-reward cells',pad=50)
df.to_csv(r'Z:\condition_df\farpost_trialtype.csv')

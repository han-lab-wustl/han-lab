...
from projects.pyr_reward.rewardcell import get_radian_position,reward_act_v_probes_allrew
# import condition df
...
for ii in range(len(conddf)):
    ...
    if (animal!='e217') & (conddf.optoep.values[ii]<2):
        ...
        tcs_correct,tcs_probes,com_correct,cs=reward_act_v_probes_allrew(ii,params_pth,\

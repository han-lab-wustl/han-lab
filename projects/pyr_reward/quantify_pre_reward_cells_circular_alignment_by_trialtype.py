...
saveddataset = rf'Z:\saved_datasets\radian_tuning_curves_prereward_cell_bytrialtype_nopto_{goal_window_cm}cm_window.p'
...
bins=90
saveto = rf'Z:\saved_datasets\radian_tuning_curves_prereward_cell_bytrialtype_nopto_{goal_window_cm}cm_window.p'
...
for ii in range(len(conddf)):
    ...
    if animal!='e217' and conddf.optoep.values[ii]<2:
        ...
        goal_cell_iind,perm,goal_cell_prop,num_epoch,goal_cell_null=extract_data_prerew(ii,
...
ax.set_title('Pre-reward cells',pad=90)

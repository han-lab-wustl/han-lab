...
for ii in range(len(conddf)):
    ...
    if (animal!='e217') & (conddf.optoep.values[ii]<2):
        ...
        meanangles_gc, rvals_gc, meanangles_all_gc, rvals_all_gc, tcs_correct, coms_correct, \
        goal_cells, all_goal_cells=get_circular_data(ii,params_pth,animal,day,bins,radian_alignment,
            ...
            num_iterations=1000)
        meanangles_all_.append(meanangles_gc)

function [mean_length_of_transients_per_cell_opto,....
    ...
    auc_transients_per_cell_ctrl, peak_transients_per_cell_opto, peak_transients_per_cell_ctrl] = get_transient_stats_first_5(trialnum, ....
    changeRewLoc,gainf,ybinned, putative_pcs, Fc3, iscell,...
    stat, optoep)
...
eprng = eprng(trialnum_>2 & trialnum_<8); % limit to first 5 trials
ypos = ybinned(eprng);
...
try
    ...
    fc3_pc = Fc3(eprng,:); % for masterhrz data
end

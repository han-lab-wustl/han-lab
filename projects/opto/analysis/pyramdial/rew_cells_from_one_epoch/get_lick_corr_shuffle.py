...
plt.savefig(os.path.join(savedst, f'fig5_mean_lick_correlation_shuffle.svg'), bbox_inches='tight')
df.to_csv(r'Z:\saved_datasets\lick_corr_shuffle.csv')
#%%

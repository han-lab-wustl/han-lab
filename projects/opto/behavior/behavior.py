...
def get_performance(eptest, eps, trialnum, rewards, licks, \
    ...
    vel_opto = get_mean_velocity_per_ep(forwardvel_[ybinned_<(rewloc-(rewsize/2))]) # pre-reward
    ...
    vel_prev = get_mean_velocity_per_ep(forwardvel_[ybinned_<(rewloc-(rewsize/2))])

...
for day=days
    ...
    plot(find(mouse.VR.reward==0.5),ypos(find(mouse.VR.reward==1)),'b*', ...
        'MarkerSize',5)
...
% save ppt
fl = pptx.save(fullfile('Y:\sstcre_analysis',sprintf('%s_behavior',mouse_name)));
% 

...
clear all; close all;
%days=[]; 
srcs = ['E:\Ziyi\Data\241018_ZH\241018_ZH_000_001'];
% src = 'X:\vipcre\e217';
lenVid=3000;
...
stdNum = 1.5; %vary based on yoiur data
loadVideoTiffNoSplit_Opto_stims_concat(srcs, lenVid,artifact_type,bandlimit,stdNum);
%loadVideoTiffNoSplit_Opto_stims_concat(srcs, lenVid,artifact_type,bandlimit,stdNum)

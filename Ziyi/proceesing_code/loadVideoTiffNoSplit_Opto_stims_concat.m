function loadVideoTiffNoSplit_Opto_stims_concat(srcs, lenVid,artifact_type,bandlimit,stdNum)
...
for src=srcs
    ...
    filename = dir(fullfile(srcs, '*.sbx'));
    ...
    % set stddev filter
    filter = int16(stddevs)*stdNum; % 2 * std dev if blue laser of green signal
    ...
    stims1 = [stims1; tempstims];

    save([stripped_filename '.mat'],'stims1','-append')

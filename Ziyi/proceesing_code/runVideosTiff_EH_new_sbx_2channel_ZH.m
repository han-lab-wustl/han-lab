%runVideos
%200820 EH. points to "loadVideoTiffNoSplit_EH2_new_sbx" for new splobx form.
...
%     loadVideoTiff(paths{f},files{f},num_planes(f),Fs);
    loadVideoTiffNoSplit_EH2_new_sbx_2channel_ZH(paths{f},files{f},scan_type{f});
end
...
%     %To use hmm
%     systemCommand = ['python C:/Users/han/Documents/Python_Scripts/simahmm.py ', file, ' ', num2str(num_planes(i))];

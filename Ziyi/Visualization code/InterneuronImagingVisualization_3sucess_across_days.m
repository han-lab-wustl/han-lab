...
for alldays = 1:length(pr_dir0)%
    ...
    for allplanes = 1:4 %%change plane info
        ...
        if exist(pr_dir, 'dir')
            ...
            roi_speed_data_smth=smoothdata(speed_binned,'gaussian',5)';
            ...
            reward_indices = consecutive_success_csIndx;
...
mean_speed_og = mean(speed_event_data_acrossdays,2);
mean_speed = smoothdata(mean_speed_og,'gaussian',5);

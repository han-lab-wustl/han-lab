...
% 10/26/2023
% commented out and modified variables (line 93) to match variables from VR for MRZ.
...
for n = 1:numfiles
    ...
    fullFfile=[Ffilepath{n} Ffile{n}]
     pause(1);
      save(fullFfile,'ybinned','rewards','forwardvel','licks','trialnum','timedFF','lickVoltage', ...
          'VR', '-append');
      if addabf

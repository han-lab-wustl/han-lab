...
from processing_functions import find_start_points
...
src = r'E:\Ziyi\Data\LC_mice'
range_val = 12; binsize=0.2 #s
dur=3# s stim duration
planelut  = {0: 'SLM', 1: 'SR' , 2: 'SP', 3: 'SO'}
prewin = 2 # for which to normalize
#savedst = r'C:\Users\Han\Box\neuro_phd_stuff\han_2023-\dopamine_projects'
conddf = pd.read_csv(r"C:\Users\HanLab\\Downloads\Book3.csv") # day vs. condition LUT
...
for ii,animal in enumerate(animals):
    ...
    for day in days: 
        ...
        for path in Path(os.path.join(src, animal, str(day))).rglob('params.mat'):
            ...
            min_iind_1 = find_start_points(stims[offplane1::4])
            min_iind_2 = find_start_points(stims[offplane2::4])
            startofstims = np.zeros_like(dff)
            startofstims[min_iind_1]=1
            ...
            # Initialize the start of stimulations array
            startofstims = np.zeros_like(dff)

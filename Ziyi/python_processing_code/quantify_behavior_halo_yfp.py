...
plt.close('all')
# save to pdf
condrewloc = pd.read_csv(r"C:\Users\HanLab\Downloads\data_organization_halo_control_yfp_grab (version 1).csv", index_col = None)
src = r"E:\Ziyi\Data\Halo_control\srz"
animals = ['e244','e245']#,'e242','e243']
days_all = [[7,8,9,10,11,12,13,14],
            [9,10,11,12,14,15,16]]#,[29,30],[36,37]]
dst = r"E:\Ziyi\results\halo_control_yfp"

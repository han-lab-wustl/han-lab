...
for day in days: 
    ...
    for path in Path(os.path.join(src, str(day))).rglob('params.mat'):
        ...
        normmeanrewdFF_opto_str, meanrewdFF_opto_str, normrewdFF_opto_str, rewdFF_opto_str = eye.perireward_binned_activity(
            dff_opto_eps[str_bool_opto], rews_centered_opto_str, timedFF_opto_eps[str_bool_opto], range_val, binsize)
        ...
        _, meanlick_opto_str, __, licktr_opto_str = perireward_binned_activity(
            licks_opto_eps[str_bool_opto], rews_centered_opto_str, timedFF_opto_eps[str_bool_opto], trialnum_opto_eps[str_bool_opto], range_val, binsize)
        ...
        normmeanrewdFF_opto_ftr, meanrewdFF_opto_ftr, normrewdFF_opto_ftr, rewdFF_opto_ftr = eye.perireward_binned_activity(
            dff_opto_eps[ftr_bool_opto], rews_centered_opto_ftr, timedFF_opto_eps[ftr_bool_opto], range_val, binsize)
        ...
        _, meanlick_opto_ftr, __, licktr_opto_ftr = perireward_binned_activity(
            licks_opto_eps[ftr_bool_opto], rews_centered_opto_ftr, timedFF_opto_eps[ftr_bool_opto], trialnum_opto_eps[ftr_bool_opto], range_val, binsize)
        ...
        normmeanrewdFF_opto_ttr, meanrewdFF_opto_ttr, normrewdFF_opto_ttr, rewdFF_opto_ttr = eye.perireward_binned_activity(
            dff_opto_eps[ttr_bool_opto], rews_centered_opto_ttr, timedFF_opto_eps[ttr_bool_opto], range_val, binsize)
        ...
        _, meanlick_opto_ttr, __, licktr_opto_ttr = perireward_binned_activity(
            licks_opto_eps[ttr_bool_opto], rews_centered_opto_ttr, timedFF_opto_eps[ttr_bool_opto], trialnum_opto_eps[ttr_bool_opto], range_val, binsize)
       ...
       # --- STR TRIALS (nonopto) ---
        ...
        normmeanrewdFF_nonopto_str, meanrewdFF_nonopto_str, normrewdFF_nonopto_str, rewdFF_nonopto_str = eye.perireward_binned_activity(
            dff_opto_eps[str_bool_nonopto], rews_centered_nonopto_str, timedFF_opto_eps[str_bool_nonopto], range_val, binsize)
        ...
        _, meanlick_nonopto_str, __, licktr_nonopto_str = perireward_binned_activity(
            licks_opto_eps[str_bool_nonopto], rews_centered_nonopto_str, timedFF_opto_eps[str_bool_nonopto], trialnum_opto_eps[str_bool_nonopto], range_val, binsize)
        ...
        normmeanrewdFF_nonopto_ftr, meanrewdFF_nonopto_ftr, normrewdFF_nonopto_ftr, rewdFF_nonopto_ftr = eye.perireward_binned_activity(
            dff_opto_eps[ftr_bool_nonopto], rews_centered_nonopto_ftr, timedFF_opto_eps[ftr_bool_nonopto], range_val, binsize)
        ...
        _, meanlick_nonopto_ftr, __, licktr_nonopto_ftr = perireward_binned_activity(
            licks_opto_eps[ftr_bool_nonopto], rews_centered_nonopto_ftr, timedFF_opto_eps[ftr_bool_nonopto], trialnum_opto_eps[ftr_bool_nonopto], range_val, binsize)
        ...
        normmeanrewdFF_nonopto_ttr, meanrewdFF_nonopto_ttr, normrewdFF_nonopto_ttr, rewdFF_nonopto_ttr = eye.perireward_binned_activity(
            dff_opto_eps[ttr_bool_nonopto], rews_centered_nonopto_ttr, timedFF_opto_eps[ttr_bool_nonopto], range_val, binsize)
        ...
        _, meanlick_nonopto_ttr, __, licktr_nonopto_ttr = perireward_binned_activity(
            licks_opto_eps[ttr_bool_nonopto], rews_centered_nonopto_ttr, timedFF_opto_eps[ttr_bool_nonopto], trialnum_opto_eps[ttr_bool_nonopto], range_val, binsize)
        ...
        _, meanlick_nonopto_eps_str, __, licktr_nonopto_eps_str = perireward_binned_activity(
            licks[eps_nonopto_mask][str_bool_nonopto_eps], rews_centered_nonopto_eps_str,
            timedFF[eps_nonopto_mask][str_bool_nonopto_eps], trialnum[eps_nonopto_mask][str_bool_nonopto_eps], range_val, binsize)
        ...
        _, meanlick_nonopto_eps_ftr, __, licktr_nonopto_eps_ftr = perireward_binned_activity(
            licks[eps_nonopto_mask][ftr_bool_nonopto_eps],  rews_centered_nonopto_eps_ftr,
            timedFF[eps_nonopto_mask][ftr_bool_nonopto_eps], trialnum[eps_nonopto_mask][ftr_bool_nonopto_eps], range_val, binsize)
        ...
        _, meanlick_nonopto_eps_ttr, __, licktr_nonopto_eps_ttr = perireward_binned_activity(
            licks[eps_nonopto_mask][ttr_bool_nonopto_eps], rews_centered_nonopto_eps_ttr,
            timedFF[eps_nonopto_mask][ttr_bool_nonopto_eps], trialnum[eps_nonopto_mask][ttr_bool_nonopto_eps], range_val, binsize)
        ...
        # STR
        normmeanOptodFF_str, meanOptodFF_str, normOptodFF_str, optodFF_str = eye.perireward_binned_activity(
            dff_opto_eps[str_bool_opto], opto_centered[str_bool_opto], timedFF_opto_eps[str_bool_opto], range_val, binsize)
        _, meanlick_rate_opto_centered_opto_str, __, lick_rate_opto_centered_opto_str = eye.perireward_binned_activity(
            lick_rate_opto_eps[str_bool_opto], opto_centered[str_bool_opto], timedFF_opto_eps[str_bool_opto], range_val, binsize)

        # FTR
        normmeanOptodFF_ftr, meanOptodFF_ftr, normOptodFF_ftr, optodFF_ftr = eye.perireward_binned_activity(
            dff_opto_eps[ftr_bool_opto], opto_centered[ftr_bool_opto], timedFF_opto_eps[ftr_bool_opto], range_val, binsize)
        _, meanlick_rate_opto_centered_opto_ftr, __, lick_rate_opto_centered_opto_ftr = eye.perireward_binned_activity(
            lick_rate_opto_eps[ftr_bool_opto], opto_centered[ftr_bool_opto], timedFF_opto_eps[ftr_bool_opto], range_val, binsize)

        # TTR
        normmeanOptodFF_ttr, meanOptodFF_ttr, normOptodFF_ttr, optodFF_ttr = eye.perireward_binned_activity(
            dff_opto_eps[ttr_bool_opto], opto_centered[ttr_bool_opto], timedFF_opto_eps[ttr_bool_opto], range_val, binsize)
        _, meanlick_rate_opto_centered_opto_ttr, __, lick_rate_opto_centered_opto_ttr = eye.perireward_binned_activity(
            lick_rate_opto_eps[ttr_bool_opto], opto_centered[ttr_bool_opto], timedFF_opto_eps[ttr_bool_opto], range_val, binsize)
  
    
        # Non Opto trials in Opto epoch!! This is aligned to when the opto happens 

        # STR
        normmeannonOptodFF_str, meannonOptodFF_str, normnonOptodFF_str, NonoptodFF_str = eye.perireward_binned_activity(
            dff_opto_eps[str_bool_nonopto], opto_centered[str_bool_nonopto], timedFF_opto_eps[str_bool_nonopto], range_val, binsize)
        _, meanlick_rate_opto_centered_nonopto_str, __, lick_rate_opto_centered_nonopto_str = eye.perireward_binned_activity(
            lick_rate_opto_eps[str_bool_nonopto], opto_centered[str_bool_nonopto], timedFF_opto_eps[str_bool_nonopto], range_val, binsize)

        # FTR
        normmeannonOptodFF_ftr, meannonOptodFF_ftr, normnonOptodFF_ftr, NonoptodFF_ftr = eye.perireward_binned_activity(
            dff_opto_eps[ftr_bool_nonopto], opto_centered[ftr_bool_nonopto], timedFF_opto_eps[ftr_bool_nonopto], range_val, binsize)
        _, meanlick_rate_opto_centered_nonopto_ftr, __, lick_rate_opto_centered_nonopto_ftr = eye.perireward_binned_activity(
            lick_rate_opto_eps[ftr_bool_nonopto], opto_centered[ftr_bool_nonopto], timedFF_opto_eps[ftr_bool_nonopto], range_val, binsize)

        # TTR
        normmeannonOptodFF_ttr, meannonOptodFF_ttr, normnonOptodFF_ttr, NonoptodFF_ttr = eye.perireward_binned_activity(
            dff_opto_eps[ttr_bool_nonopto], opto_centered[ttr_bool_nonopto], timedFF_opto_eps[ttr_bool_nonopto], range_val, binsize)
        _, meanlick_rate_opto_centered_nonopto_ttr, __, lick_rate_opto_centered_nonopto_ttr = eye.perireward_binned_activity(
            lick_rate_opto_eps[ttr_bool_nonopto], opto_centered[ttr_bool_nonopto], timedFF_opto_eps[ttr_bool_nonopto], range_val, binsize)
        ...
        if pln == 0:
            ...
            for i in range(len(opto_stim_trs)):
                if opto_stim_trs[i] == 1 and not in_patch:
                    ...
                    ax.axvspan(start, end, color='darksalmon', alpha=0.5, zorder=0)
                    in_patch = False
            if in_patch:  # in case the last segment goes to the end
                ax.axvspan(start, len(opto_stim_trs), color='darksalmon', alpha=0.5, zorder=0)
            ...
            for ttype in trial_types:
                ...
                # Plot
                ax.plot(time_axis, mean_opto, label='Opto Trials (Opto Epoch)', color='royalblue')
                ax.fill_between(time_axis, mean_opto - sem_opto, mean_opto + sem_opto, alpha=0.3, color='royalblue')

                ax.plot(time_axis, mean_nonopto, label='Non-Opto Trials (Opto Epoch)', color='darkorange')
                ax.fill_between(time_axis, mean_nonopto - sem_nonopto, mean_nonopto + sem_nonopto, alpha=0.3, color='darkorange')
                

                ax.axvspan(0, 2, color='skyblue', alpha=0.3)
                ax.axvline(0, linestyle='--', color='gray')
                ax.set_title(f'{day} | Opto-Aligned Lick Rate\n{titles[ttype]}')
                ax.set_xlabel('Time (s)')
                ax.set_ylabel('Lick Rate')
                ax.legend()
                ax.spines[['top', 'right']].set_visible(False)
                plt.tight_layout()
                fig.savefig(os.path.join(save_dir, f"lickrate_opto_aligned_{ttype}_day_{day}.png"))
                plt.show()

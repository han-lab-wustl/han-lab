...
ROI_labels = {'Plane 1 SLM','Plane 2 SR','Plane 3 SP','Plane 4 SO'};
 dopvarnames = {'roi_dop_alldays_planes_periCS','roi_dop_alldays_planes_peridoubleCS'};
 roevarnames = {'roi_roe_alldays_planes_periCS','roi_roe_alldays_planes_peridoubleCS'};

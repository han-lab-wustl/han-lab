...
scatter(ones(size(notSOslopes(1:6)))*2,notSOslopes(1:6),25,[0.5 0.5 0.5],'filled','Jitter','on','Jitteramount',0.04)
 plot([1 2],[nanmean(SOslopes(1:6)) nanmean(notSOslopes(1:6))],'kd')
    errorbar([1 2],[nanmean(SOslopes(1:6)) nanmean(notSOslopes(1:6))],[nanstd(SOslopes(1:6)) nanstd(notSOslopes(1:6))]/sqrt(length(SOslopes(1:6))),'k','Capsize',0,'LineStyle','none','LineWidth',1.5)
   xlim([0.5 2.5])
   plot([0.5 2.5],[0 0],'k--')
...
scatter(ones(size(SOslopes(7:end))),SOslopes(7:end),25,'r','filled','Jitter','on','Jitteramount',0.04)
hold on

scatter(ones(size(notSOslopes(7:end)))*2,notSOslopes(7:end),25,[0.5 0.5 0.5],'filled','Jitter','on','Jitteramount',0.04)
 plot([1 2],[nanmean(SOslopes(7:end)) nanmean(notSOslopes(7:end))],'kd')
    errorbar([1 2],[nanmean(SOslopes(7:end)) nanmean(notSOslopes(7:end))],[nanstd(SOslopes(7:end)) nanstd(notSOslopes(7:end))]/sqrt(length(SOslopes(7:end))),'k','Capsize',0,'LineStyle','none','LineWidth',1.5)
   xlim([0.5 2.5])
   plot([0.5 2.5],[0 0],'k--')
   ylabel('Linear Fit Slope')
   xticks(1:2)
...
figure;
subplot(4,2,3)
scatter(ones(size(SOslopes(1:5))),SOslopes(1:5),25,'r','filled','Jitter','on','Jitteramount',0.04)
hold on
scatter(ones(size(SOslopes(6:end)))*2,SOslopes(6:end),25,'r','filled','Jitter','on','Jitteramount',0.04)

 plot([1 2],[nanmean(SOslopes(1:5)) nanmean(SOslopes(6:end))],'ks')
    errorbar([1 2],[nanmean(SOslopes(1:5)) nanmean(SOslopes(6:end))],[nanstd(SOslopes(1:5))/sqrt(length(SOslopes(1:5))) nanstd(SOslopes(6:end))/sqrt(length(SOslopes(6:end)))],'k','Capsize',0,'LineStyle','none','LineWidth',1.5)
   xlim([0.5 2.5])
   plot([0.5 2.5],[0 0],'k--')
   ylabel('Linear Fit Slope')
   xticks(1:2)
...
%    text(1.5,nanmean(SOslopes),['p:' num2str(p)])
    [~,p] = ttest(SOslopes(1:5));
    text(1,nanmean(SOslopes(1:5)),['p:' num2str(p)])
    [~,p] = ttest(SOslopes(6:end));
    text(2,nanmean(SOslopes(6:end)),['p:' num2str(p)])
   
   
 subplot(4,2,4)

scatter(ones(size(notSOslopes(1:5))),notSOslopes(1:5),25,[0.5 0.5 0.5],'filled','Jitter','on','Jitteramount',0.04)
hold on

scatter(ones(size(notSOslopes(6:end)))*2,notSOslopes(6:end),25,[0.5 0.5 0.5],'filled','Jitter','on','Jitteramount',0.04)
 plot([1 2],[nanmean(notSOslopes(1:5)) nanmean(notSOslopes(6:end))],'ks')
    errorbar([1 2],[nanmean(notSOslopes(1:5)) nanmean(notSOslopes(6:end))],[nanstd(notSOslopes(1:5))/sqrt(length(SOslopes(1:5))) nanstd(notSOslopes(6:end))/sqrt(length(SOslopes(6:end)))],'k','Capsize',0,'LineStyle','none','LineWidth',1.5)
   xlim([0.5 2.5])
   plot([0.5 2.5],[0 0],'k--')
   ylabel('Linear Fit Slope')
   xticks(1:2)
...
[~,p] = ttest(notSOslopes(1:5));
    text(1,nanmean(notSOslopes(1:5)),['p:' num2str(p)])
    [~,p] = ttest(notSOslopes(6:end));
    text(2,nanmean(notSOslopes(6:end)),['p:' num2str(p)])
   
%
% figure;
subplot(4,2,7)
scatter(ones(size(SORsquared(1:5))),SORsquared(1:5),25,'r','filled','Jitter','on','Jitteramount',0.04)
hold on
scatter(ones(size(SORsquared(6:end)))*2,SORsquared(6:end),25,'r','filled','Jitter','on','Jitteramount',0.04)

 plot([1 2],[nanmean(SORsquared(1:5)) nanmean(SORsquared(6:end))],'ks')
    errorbar([1 2],[nanmean(SORsquared(1:5)) nanmean(SORsquared(6:end))],[nanstd(SORsquared(1:5))/sqrt(length(SORsquared(1:5))) nanstd(SORsquared(6:end))/sqrt(length(SORsquared(6:end)))],'k','Capsize',0,'LineStyle','none','LineWidth',1.5)
   xlim([0.5 2.5])
   plot([0.5 2.5],[0 0],'k--')
   ylabel('rsquared')
   xticks(1:2)
...
scatter(ones(size(notSORsquared(1:5))),notSORsquared(1:5),25,[0.5 0.5 0.5],'filled','Jitter','on','Jitteramount',0.04)
hold on

scatter(ones(size(notSORsquared(6:end)))*2,notSORsquared(6:end),25,[0.5 0.5 0.5],'filled','Jitter','on','Jitteramount',0.04)
 plot([1 2],[nanmean(notSORsquared(1:5)) nanmean(notSORsquared(6:end))],'ks')
    errorbar([1 2],[nanmean(notSORsquared(1:5)) nanmean(notSORsquared(6:end))],[nanstd(notSORsquared(1:5))/sqrt(length(SORsquared(1:5))) nanstd(notSORsquared(6:end))/sqrt(length(SORsquared(6:end)))],'k','Capsize',0,'LineStyle','none','LineWidth',1.5)
   xlim([0.5 2.5])
   plot([0.5 2.5],[0 0],'k--')
   ylabel('Rsqaured')
   xticks(1:2)

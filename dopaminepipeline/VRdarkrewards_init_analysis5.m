...
%                 text(5, min(ylim), 'Moving', 'Horiz','right', 'Vert','bottom')
            ...
            for roii = 1:length(params.roibasemean)
                roibase_mean = params.roibasemean{roii};
                roimean_base_mean=mean(params.roibasemean{roii});
            ...
            save('params','roinorm_double_tracesCS','roinorm_double_traces_roesmthCS','-append')
             ...
             if exist('roisingle_traces','var')
                ...
                save('params','roi_double_traces','roi_norm_double_traces','roi_single_traces','roi_norm_single_traces','-append')

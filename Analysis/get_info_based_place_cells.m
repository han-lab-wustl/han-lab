function place_cells = get_info_based_place_cells(Fc3,position,Fs,nBins,track_length)

cell_info = get_spatial_info_all_cells(Fc3,position,Fs,nBins,track_length); % nCelss X 1
cell_info_shuffled = get_shuffled_cell_info(Fc3,position,Fs,nBins,track_length); %nShuffles X nCells

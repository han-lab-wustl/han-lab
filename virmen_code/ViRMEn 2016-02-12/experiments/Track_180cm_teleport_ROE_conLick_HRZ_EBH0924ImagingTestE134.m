function code = Track_180cm_teleport_ROE_conLick_HRZ_EBHImagingTestE134
...
vr.gainFactor = 2; % Gain in the track. The smaller, the longer the track. 1= usual gain. This value is multiplied by num rpm from ROE
p = 0.4 ;%probability of having probe trial at the beginning
vr.lickThreshold = -0.087; % might need to adjust

function code = Track_270cm_ROE_HRZ_NoReward_final_brighter_10cmRewLoc_MM_sol2
...
vr.lickThreshold = -0.06; % might need to adjust
vr.goal = 90; % HERE state the automatic reward location
vr.lickControl =2; % HERE state the if lick is necessary to get reward
vr.posControl = 1;
vr.countControl = 1;

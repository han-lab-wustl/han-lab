function code = Track_180cm_teleport_ROE_conLick_HRZ_EBH1009ImagEBGM2102
...
vr.world2color = [0.22 0.22 0.22]; %22 change the background color on world 2
vr.world2darkTimeColor = [0.15 0.15 0.15]; %15 change the background color on 'darktime' in world 2

function code = Track_180cm_eh_switchRotGain_variable_rew_ROE_test_noVR
%make world invisible. 200120
%for tracking movement with ROE without VR
%also disabled rewards

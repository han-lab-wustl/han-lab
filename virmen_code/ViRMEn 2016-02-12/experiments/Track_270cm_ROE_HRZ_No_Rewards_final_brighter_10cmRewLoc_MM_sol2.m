function code = Track_270cm_ROE_HRZ_nlickcon_final_brighter_10cmRewLoc_MM_sol2
...
vr.lickControl =2; % HERE state the if lick is necessary to get reward 2 FOR NO REEWARDS mm
vr.posControl = 1;
vr.countControl = 1;

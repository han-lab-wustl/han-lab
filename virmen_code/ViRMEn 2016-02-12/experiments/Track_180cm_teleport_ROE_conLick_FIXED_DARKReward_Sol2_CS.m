function code = Track_180cm_teleport_ROE_conLick_HRZ_RandReward_Sol2_CS
...
vr.lickThreshold = -0.07; % might need to adjust
...
vr.minIRI = 30; %minimum time between rewards automatic
vr.maxIRI = 30; %maximum time between rewards automatic

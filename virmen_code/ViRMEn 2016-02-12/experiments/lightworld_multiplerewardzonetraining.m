 function code = lightworld_multiplerewardzonetraining
...
% 12)---------------------------------
vr.gainFactor = 2/3;
vr.numRewZones=8; %set the desired number of reward zones
vr.rewardZone = 20*vr.gainFactor; % length of reward zone after currentGoal
...
vr.lickThreshold = -0.07;% might need to adjust, unfortunately the clampex recording is not reliable, use licksensor_toy
...
vr.worlds{1, 1}.backgroundColor = [0.23 0.23 0.23]; % change the VR background color; ZD changed for world 1

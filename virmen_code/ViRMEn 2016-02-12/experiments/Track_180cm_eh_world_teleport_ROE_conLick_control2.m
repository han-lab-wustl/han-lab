function code = Track_180cm_eh_world_teleport_ROE_conLick_control2
...
% catch
    vr.lickThreshold = -0.028;% might need to adjust, unfortunately the clampex recording is not reliable, use licksensor_toy
% end
...
if vr.random_initiation
    vr.allGoals(1) = randi([50,150]);%world 2 random [min max] (1)EB 0630
end

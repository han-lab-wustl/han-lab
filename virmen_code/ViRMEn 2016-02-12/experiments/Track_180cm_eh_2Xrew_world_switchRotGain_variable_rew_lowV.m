function code = Track_180cm_eh_2Xrew_world_switchRotGain_variable_rew_lowV
...
%200803 EH. Change vr.track_gain or end gain
if double(vr.keyPressed == 52) %ascii code for "4"
%     vr.track_gain = vr.track_gain-0.1;
%     disp(vr.track_gain)
    vr.end_gain = vr.end_gain-0.1;
    disp(vr.end_gain)
...
%200805 EH. Change vr.track_gain 

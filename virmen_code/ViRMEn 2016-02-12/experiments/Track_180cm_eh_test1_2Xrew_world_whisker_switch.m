function code = Track_180cm_eh_test1_2Xrew_world_whisker_switch
% start m3, switch to invisible m3, then back
...
%             vr.worlds{vr.currentWorld}.surface.visible(:) = false; % make all triangles invisible
        if vr.currentVis ==1; %
            ...
            vr.worlds{vr.currentWorld}.surface.visible(:) = true; % make all triangles visible
        end  

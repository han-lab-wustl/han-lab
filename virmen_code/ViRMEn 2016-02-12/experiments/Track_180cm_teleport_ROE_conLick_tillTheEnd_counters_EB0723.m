function code = Track_180cm_teleport_ROE_conLick_tillTheEnd_counters_EB0723
...
% end
vr.gamemode = 0; % decide if the lick outside "reward zone" counts % =1 EB 0630

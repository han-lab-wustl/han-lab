...
vr.lickThreshold = -0.069; % might need to adjust
...
vr.timer = toc;
% if vr.timer-vr.saved>=vr.newInterval(vr.rewardIdx) && vr.timer > 120+vr.newInterval(1) && vr.notDone % afer 2 mins in the dark, start giving random rewards
%     %     vr.saved = vr.timer;
%     disp(vr.saved)

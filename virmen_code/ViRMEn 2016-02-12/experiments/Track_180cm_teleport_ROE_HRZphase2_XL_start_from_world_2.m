function code = Track_180cm_teleport_ROE_HRZphase2_XL_start_from_world_2
...
vr.automaticExperimentWorld = 6; % automatically change the current World after n = vr.automaticExperimentWorldNRewZones reward locations.

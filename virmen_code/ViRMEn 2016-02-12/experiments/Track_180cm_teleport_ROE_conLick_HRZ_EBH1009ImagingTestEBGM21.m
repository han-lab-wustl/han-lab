function code = Track_180cm_teleport_ROE_conLick_HRZ_EBH1009ImagingTestEBGM
...
VR.wOff = vr.wOff ;
VR.gainFactor = vr.gainFactor; % Gain in the track. The smaller, the longer the track. 1= usual gain. This value is multiplied by num rpm from ROE

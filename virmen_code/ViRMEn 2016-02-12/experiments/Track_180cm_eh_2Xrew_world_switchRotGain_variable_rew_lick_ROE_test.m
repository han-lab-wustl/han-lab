function code = Track_180cm_eh_2Xrew_world_switchRotGain_variable_rew_lick_ROE_test
...
vr.lickThreshold = 4.98;%4.9;% calibrated threshold for what the arduino reads to be a lick
...
currentlick = readVoltage(vr.licksensor,'A0');

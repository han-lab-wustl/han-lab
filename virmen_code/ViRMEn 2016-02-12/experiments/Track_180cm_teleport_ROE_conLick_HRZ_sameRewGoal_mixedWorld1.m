function code = Track_180cm_teleport_ROE_conLick_HRZ_sameRewGoal_Fam1
...
vr.goal = 109.5; % HERE state the automatic reward location% 75cm for fam1 EB 0625
...
if vr.position(2) >= 90
    vr.worlds{1, 1}.backgroundColor = vr.world2color; % change the VR background color
else

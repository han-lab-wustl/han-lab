function code = Track_180cm_teleport_ROE_HRZ_brighter_5cmRewLoc_GM_sol2_OptoInf
...
%optogenetics transmition end
if double(vr.keyPressed)== 74 % if "j" the key right under escape is pressed

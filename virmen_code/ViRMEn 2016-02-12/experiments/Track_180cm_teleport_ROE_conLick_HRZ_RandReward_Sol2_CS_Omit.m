function code = Track_180cm_teleport_ROE_conLick_HRZ_RandReward_Sol2_CS_Omit
...
vr.lickThreshold = -0.068; % might need to adjust
...
vr.initialWaitPeriod = 60; %seconds before delivering automatic rewards;

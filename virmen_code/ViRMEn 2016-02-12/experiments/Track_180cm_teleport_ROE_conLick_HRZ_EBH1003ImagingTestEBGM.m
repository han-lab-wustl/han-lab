function code = Track_180cm_teleport_ROE_conLick_HRZ_EBH1003ImagingTestEBGM
...
vr.numProbes = 1; % number of probe trials (remember for analysis that their index start from 0)

function code = Track_270cm_teleport_ROE_lightworld_20cmRewLoc_ZH_HRZ_noprobes
...
vr.numProbes = 2; % number of probe trials (remember for analysis that their index start from 0)

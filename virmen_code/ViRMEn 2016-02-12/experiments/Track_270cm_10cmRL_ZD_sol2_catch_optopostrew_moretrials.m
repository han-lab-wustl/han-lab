function code = Track_270cm_10cmRL_ZD_sol2_catch_optopostrew_moretrials
...
if vr.optoIson == 0 % ZD: only post rew opto
     if vr.trialNum(1,vr.t)>vr.numProbes-1 && ((vr.position(2)>(vr.goal+(vr.rewardZone/2))) || vr.eligible == 0) && sum(vr.optoEp == sum(vr.changeRewLoc~=0))>0  && ~rem(vr.trialNum(1,vr.t),10)==0

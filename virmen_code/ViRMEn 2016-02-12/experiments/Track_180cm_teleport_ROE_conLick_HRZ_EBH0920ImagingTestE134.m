function code = Track_180cm_teleport_ROE_conLick_HRZ_EBH0920ImagingTestE134
...
vr.lickThreshold = -0.019; % might need to adjust
...
global lickSensor islick roe timeROE scalingFACTOR imageSync
vr.t=vr.t+1;
vr.imageSync(vr.t)=imageSync;

function vr = initializeDAQ_low_view_V_conLick_ROE_imageSync(vr)
%2000920. EBH image synch TTL from scanbox, input into ai5.
...
vr.imageSync = addAnalogInputChannel(vr.moveSession, 'Dev1', 'ai5', 'Voltage');%2000920. EBH
%OUPUTS

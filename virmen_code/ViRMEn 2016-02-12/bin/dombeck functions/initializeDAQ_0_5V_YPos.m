function vr = initializeDAQ_0_5V_YPos(vr)
% modified to output YPos as 0-5V YPos (normal range -10 -10V
%when connected to Manning's piezo stim circuit
...
vr.yScaling = 18/(str2double(vr.exper.variables.trackLength)*2.7);
vr.yOffset = 0;%Use all of dynamice range -10 V to 10V, offset to start at -9
